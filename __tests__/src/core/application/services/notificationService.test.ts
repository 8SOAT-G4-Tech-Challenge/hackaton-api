...
describe('NotificationService', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        notificationService = new NotificationService(notificationRepositoryMock, smsServiceMock as any);
    });
    ...
    describe('createNotification', () => {
        ...
        it('should create notification successfully and send SMS when userPhoneNumber is provided', async () => {
            ...
            expect(smsServiceMock.sendSms).toHaveBeenCalledWith(params.userPhoneNumber, expectedText);
            expect(result).toEqual(createdNotification);
        });
