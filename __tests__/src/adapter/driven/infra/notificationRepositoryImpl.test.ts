...
describe('NotificationRepositoryImpl', () => {
    ...
    describe('getNotificationById', () => {
        it('should return a notification when found', async () => {
            ...
            (prisma.notification.findUnique as jest.Mock).mockResolvedValue(notificationMock);
        ...
        it('should return null if notification is not found', async () => {
            ...
            expect(prisma.notification.findUnique).toHaveBeenCalledWith({ where: { id: 'non-existent-id' } });
    ...
    describe('getNotificationsByUserId', () => {
        it("should return notifications for a given userId", async () => {
            ...
            expect(prisma.notification.findMany).toHaveBeenCalledWith({ where: { userId: 'user-1' } });
    ...
    describe('createNotification', () => {
        it('should create and return a new notification', async () => {
            ...
            const createdNotification: Notification = { ...inputNotification, id: 'notif-1' };
